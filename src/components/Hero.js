    ...
    return (
        <>
            ...
            <section id='hero' class="bg-white dark:bg-gray-900 ">
                <NavBar />
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto -mt-20 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-6">
                        ...
                        <a href="#swap" >
                            <button type="button" class="text-white bg-gradient-to-r from-blue-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-2xl px-5 py-3 text-center me-2 mb-2">Get started!</button>
                        </a>
                    </div>
