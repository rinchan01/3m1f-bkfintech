...
export default function LimitContent() {
    return (
        <>
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Limit price</label>
            <form class="mb-3 w-full">
                <div class="flex h-full">
                    <button id="dropdown-button" data-dropdown-toggle="ratio" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-md font-xl text-center text-gray-900 bg-gray-100 border border-e-0 border-gray-300 dark:border-gray-700 dark:text-white rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800" type="button">
                        Select ratio
                        <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg></button>
                    <div id="ratio" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            ...
            <form>
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">You pay</label>
                <div class="flex h-full">
            ...
            <form class="mt-3">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">You receive</label>
                <div class="flex h-full">
            ...
            <select id="expiry" class=" mt-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <button type="button" class=" mt-5 w-40 text-white bg-gradient-to-br from-purple-500 to-blue-300 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-xl text-lg px-5 py-2.5 text-center me-2 mb-2">Confirm</button>
