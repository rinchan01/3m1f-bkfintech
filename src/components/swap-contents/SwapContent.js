                ...
                <div className="w-full border border-slate-300 border-solid rounded-lg p-4">
                    <div className="relative mt-4">
                        ...
                        <div id='swap-content' className={`mt-5 flex-col flex-1 ${!pairSelected ? 'opacity-40' : ''}`}>
                            ...
                            <button className='bg-blue-200 hover:bg-blue-300 text-blue-600 font-bold rounded-lg px-5 py-2.5 text-center justify-center' disabled={!pairSelected}>Swap</button>
                        </div>
                    </div>
                </div>
            </div>
