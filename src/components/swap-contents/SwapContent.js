...
export default function SwapContent() {
    return (
        <>
            ...
            <button type="button" class=" mt-5 w-40  bg-blue-200 hover:bg-blue-300 text-blue-600 font-bold rounded-xl text-lg px-5 py-2.5 text-center me-2 mb-2">Swap</button>
