...
const AddPosition = () => {
    ...
    const pairs = [
        {
            coin: 'ETH',
            img: 'https://clipground.com/images/ethereum-png-12.png'
        },
        {
            coin: 'DAI',
            img: 'https://www.pngall.com/wp-content/uploads/10/Dai-Crypto-Logo-PNG-Image-HD.png'
        },
        {
            coin: 'USDT',
            img: 'https://aurpay.net/wp-content/uploads/2022/12/icon_usdt.svg'
        }
    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="flex-col flex justify-center items-center h-full">
                <div className="flex-col flex h-screen w-2/6 border border-solid border-gray-300 rounded-lg p-4">
                    <h1 className='border-b border-solid border-gray-300 p-4 font-bold'>Add liquidity</h1>
                    <div className="relative mt-4">
                        <h2 className='mb-4 flex justify-center font-bold'>Select pair</h2>
                        ...
                        <div className=' w-full border border-solid border-gray-300 rounded-lg p-4 mt-5 mb-5'>
                            <p>{fee} fee tier</p>
                        </div>

                        <div className='flex-col flex'>
                            <h2 className='mb-4 flex justify-center font-bold'>Set price range</h2>
